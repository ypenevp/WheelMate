...
const TABS = [
    { name: 'Home', route: 'Home', icon: 'map-marker-alt', lib: 'fontisto' },
                ...
                return (
                    ...
                    >
                        <Animated.View style={{ transform: [{ scale: iconScale }] }}>
                            {tab.lib === 'material' ? (
                                <MaterialCommunityIcons name={tab.icon} size={26} color={isActive ? GREEN : INACTIVE} />
                            ) : (
                                <Fontisto name={tab.icon} size={26} color={isActive ? GREEN : INACTIVE} />
                            )}
                        </Animated.View>
